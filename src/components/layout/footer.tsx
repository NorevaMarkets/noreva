        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 md:col-span-1 mb-4 sm:mb-0">
            ...
            <p className="text-sm text-[var(--foreground-muted)] leading-relaxed max-w-xs">
              Trade tokenized stocks on Solana. 24/7 access to traditional markets.
            </p>
          </div>

          {/* Navigation */}
          <div>
            <h3 className="text-sm font-semibold text-[var(--foreground)] uppercase tracking-wider mb-3 sm:mb-4">
              Navigate
            </h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link href="/" className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors">
                  Stocks
                </Link>
              </li>
              <li>
                <Link href="/trade" className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors">
                  Trade
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/about" className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors">
                  About
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link href="/privacy" className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors">
                  Privacy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors">
                  Terms
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="flex sm:flex-col gap-4 sm:gap-3">
              ...
              <a 
                href="https://github.com/NorevaMarkets/noreva" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-sm text-[var(--foreground-muted)] hover:text-[var(--accent)] transition-colors flex items-center gap-2"
              >
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-[var(--border)]">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4 text-center sm:text-left">
            <p className="text-xs text-[var(--foreground-subtle)]">
              © {currentYear} Noreva. All rights reserved.
            </p>
            <p className="text-xs text-[var(--foreground-subtle)]">
              Built on Solana
            </p>
